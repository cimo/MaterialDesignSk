...
class Utility {
    ...
    public function assignUserPassword($type, $user, $parameters) {
        ...
        if ($type == "withOld") {
            ...
            else if ($parameters['new'] != $parameters['newConfirm'])
    ...
    public function createUserSelectHtml($selectId, $isRequired = false) {
